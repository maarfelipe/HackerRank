...
if __name__ == '__main__':
    ...
    unique_scores = sorted(set(score for name, score in nested_list))
    second_lowest_score = unique_scores[1]

    # Obtém os nomes dos alunos que têm a segunda menor nota
    names = sorted(name for name, score in nested_list if score == second_lowest_score)

    # Imprime os nomes dos alunos que têm a segunda menor nota
    for name in names:
        print(name)
